...
public class MainActivity extends AppCompatActivity OnClickListener {
        ...
        try {
            switch (v.getId()){
                ...
                case R.id.btn_three:
                    ...
                    et_result.setText(et_result.getText().toString()+btn_three.getText());
                        break;

                case R.id.btn_four:

                    et_result.setText(et_result.getText().toString()+btn_four.getText());
                        break;

                case R.id.btn_five:

                    et_result.setText(et_result.getText().toString()+btn_five.getText());
                        break;

                case R.id.btn_six:

                    et_result.setText(et_result.getText().toString()+btn_six.getText());
                        break;

                case R.id.btn_seven:

                    et_result.setText(et_result.getText().toString()+btn_seven.getText());
                        break;

                case R.id.btn_eight:

                    et_result.setText(et_result.getText().toString()+btn_eight.getText());
                        break;


                case R.id.btn_nine:

                    et_result.setText(et_result.getText().toString()+btn_nine.getText());
                        break;

                case R.id.btn_zero:

                    et_result.setText(et_result.getText().toString()+btn_zero.getText());
                        break;

                case R.id.btn_point:

                    et_result.setText(et_result.getText().toString()+btn_point.getText());
                        break;
                ...
                case R.id.btn_equal:
                    ...
                    c_model = new ModelActivity(num1,
                            Double.parseDouble(et_result.getText().toString()));
